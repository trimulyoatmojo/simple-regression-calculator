...
let buttonAtas = firstClick.addEventListener("click", function (){
    ...
    firstClick.setAttribute("hidden", " ");
    inputNumber.setAttribute("hidden", " ");
    document.querySelector("label").setAttribute("hidden", " ");
    ...
    secondClick.addEventListener( "click", function() {
        ...
        secondClick.setAttribute("hidden", " ");
