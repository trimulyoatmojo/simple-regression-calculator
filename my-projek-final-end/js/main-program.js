...
let section = document.querySelector("section.data");
...
let th1= documdivSeent.createTextNode("Y");
...
for(let i = 0; i < inputNumber.value; i++){
	...
	tdInputY.setAttribute("placeholder", "number");
	...
	tdInputX.setAttribute("placeholder", "number");
}
...
secondClick.addEventListener( "click", function() {
	secondClick.setAttribute("style", "display:none;");
...
// mengisi (Y-Yrata)^2
	...
	let sectionHasil = document.createElement("section");
	divSection.appendChild(sectionHasil);
	sectionHasil.appendChild(document.createElement("hr"));
	// sectionHasil.classList.add()

// koefisien determinasi / R^2
	let R2 = 1 - (totalJmlYYpred / totalJmlYYrata);
	console.log("============================== Koefisien Dererminasi / R^2:");
	console.log(R2);
	sectionHasil.appendChild(document.createTextNode("R2 = "))
	sectionHasil.appendChild(document.createTextNode(R2));
	sectionHasil.appendChild(document.createElement("hr"));
...
// koefisien determinasi disesuaikan (adjusted)
	...
	console.log(Radj);
	sectionHasil.appendChild(document.createTextNode("Radj = "))
	sectionHasil.appendChild(document.createTextNode(Radj));
	sectionHasil.appendChild(document.createElement("hr"));
...
// kesalahan baku estimasi
	...
	console.log("============================== Se:");
	console.log(Se);
	sectionHasil.appendChild(document.createTextNode("Se = "))
	sectionHasil.appendChild(document.createTextNode(Se));
	sectionHasil.appendChild(document.createElement("hr"));
...
// standar error koefisien regresi
	...
	console.log("============================== Sb:");
	console.log(Sb);
	sectionHasil.appendChild(document.createTextNode("Sb = "))
	sectionHasil.appendChild(document.createTextNode(Sb));
	sectionHasil.appendChild(document.createElement("hr"));
...
// k = letiabel
	...
	console.log("============================== F:");
	console.log(F);
	sectionHasil.appendChild(document.createTextNode("F = "))
	sectionHasil.appendChild(document.createTextNode(F));
	sectionHasil.appendChild(document.createElement("hr"));
...
// uji t
	...
	console.log("============================== T:");
	console.log(Thitung);
	sectionHasil.appendChild(document.createTextNode("Thitung = "))
	sectionHasil.appendChild(document.createTextNode(Thitung));
	sectionHasil.appendChild(document.createElement("hr"));
});